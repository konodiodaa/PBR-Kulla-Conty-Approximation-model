...
Vec3f IntegrateBRDF(Vec3f V, float roughness, float NdotV) {
    ...
    float B = 0.0;
    float C = 0.0;
    const int sample_count = 1024;  // sampling count
    ...
    for (int i = 0; i < sample_count; i++) {
        ...
        Vec3f L = sampleList.directions[i]; //L direction, to simplify the scene, intensity = 1.
        ...
        // F term. F = 1 since no refraction with the current material.
